        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between h-full">
            <div>
              ...
              >
                Fill out the form and tell us a bit about your business - the more context you give us, the faster we can come back with something useful.              </motion.p>
                ...
                >
                  <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="flex flex-col gap-2">
                        <label htmlFor="company" className="text-[15px] font-bold text-navy">What’s your company or brand?</label>
                        <input
                          type="text"
                          id="company"
                          name="company"
                      ...
                      <div className="flex flex-col gap-2">
                        <label htmlFor="contactNumber" className="text-[15px] font-bold text-navy">What’s your contact number?</label>
                        <input
                          type="text"
                          id="contactNumber"
                          name="contactNumber"
                        ...
                        {servicesList.map((service) => {
                          ...
                          return (
                            <button
                              ...
                              className={`group relative flex items-center justify-between p-4 bg-white border-2 rounded-custom-sm transition-all duration-300 cursor-pointer select-none text-left focus:outline-none ${isSelected
